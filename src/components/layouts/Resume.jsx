    ...
    <section id="resume" className="max-w-6xl mx-auto px-6 py-28">
      <div className="space-y-14">
        <div className="space-y-4">
          <h2 className="text-5xl font-bold text-primary">Experience & Education</h2>
          <p className="text-lg text-secondary max-w-2xl">My professional journey and academic background.</p>
        </div>

        <div className="grid md:grid-cols-2 gap-12">
          {/* Experience */}
          <div className="space-y-8">
            <h3 className="text-xl font-bold text-foreground uppercase tracking-wide text-primary">Experience</h3>
            <div className="space-y-8">
          ...
          {/* Education */}
          <div className="space-y-8">
            <h3 className="text-xl font-bold text-primary uppercase tracking-wide ">Education</h3>
            <div className="space-y-8">
              <div className="border-l-2 border-[#009c8d] pl-4 space-y-2 hover:border-[#009c8d]/80 transition-colors">
